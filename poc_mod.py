...
int main(int argc, char **argv)
{
         ...
         */
        {
                ...
                errno = 0;
                ret = syscall(NR_keyctl, 0L /* KEYCTL_GET_KEYRING_ID */,
                              (long)KEY_SPEC_SESSION_KEYRING, 0L, 0L, 0L);
                ...
                errno = 0;
                ret = syscall(NR_keyctl, 14L /* KEYCTL_REQUEST2 */,
                              "cifs.spnego", desc, "x",
                ...
                errno = 0;
                ret = syscall(NR_keyctl, 14L,
                              "cifs.spnego", desc, (void *)0,
                              (long)KEY_SPEC_SESSION_KEYRING);
                fprintf(stderr, "    rc=%ld errno=%d (%s)\n",
                        ret, errno, strerror(errno));
        }
